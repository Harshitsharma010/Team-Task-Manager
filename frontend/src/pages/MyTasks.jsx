...
class MyTasks extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tasks: [], filter: "all", loading: true, updating: null, error: "",
    };
    ...
    return (
      <div className="my-tasks page-enter">
        <div className="my-tasks-header">
          <div>
            <h1>My Tasks</h1>
            <p className="my-tasks-sub">Everything assigned to you across all projects</p>
          </div>
        </div>
        ...
        {loading ? (
          <div className="my-tasks-loading"><span className="spinner" /></div>
        ) : error ? (
          ...
          <div className="tasks-list">
            {filtered.map((t) => (
              <div key={t.id} className={`task-row ${this.isOverdue(t) ? "task-row--overdue" : ""}`}>
